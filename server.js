                ...
                const isOn = (() => {
                    if (status && e.toggle) {
                        const k =  e.toggle
                            ...
                            .filter(f => f.match && ((f.match.string) ? f.match.string.filter(j => status[0].toLowerCase().includes(j.toLowerCase())).length !== 0 : f.match.filter(j => status[0].toLowerCase().includes(j.toLowerCase())).length !== 0) )
